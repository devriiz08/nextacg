...
const Hero = () => {
  return (
    <section
      ...
      id="hero"
    >
      <h1 className="antialiased text-center lg:text-start font-bold text-secondary text-2xl lg:text-4xl max-w-xl">
        Mewujudkan Karya Seni Arsitektur yang Abadi Melalui Inovasi GRC Cetak
        Berkualitas Tinggi
      </h1>
      <p className="max-w-xl antialiased font-medium mt-7 mb-5 text-muted-foreground lg:text-start text-center text-neutral-300">
